...
const PrincipalContainer = (props) => {
    ...
    useEffect(() => {
        select(planets[actualPlanet].name, planets[actualPlanet].description, planets[actualPlanet].source)
    },[actualPlanet]);
    ...
    const select = (name, description, source) => {
        setName(name);
        ...
        <div className="principal">
            ...
            <div>
                ...
                <div>
                    ...
                    />
                    <ButtonMolecule onClick={handleOnClick} classPlanet={actualPlanet}/>
                </div>
            </div>
            <div>
                <CardInfo />
